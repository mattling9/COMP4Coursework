...
\hfill\includegraphics[width = \textwidth]{./Evaluationimages/graph-evidence-1.pdf}
\end{figure}

\begin{figure}[H]
\caption{Graph displaying daily sales of a product} \label{fig:graph-evidence-2.pdf}
\hfill\includegraphics[width = \textwidth]{./Evaluationimages/graph-evidence-2.pdf}
\end{figure}
...
\hfill\includegraphics[width = \textwidth]{./Evaluationimages/invoice.pdf}
\end{figure}
...
\hfill\includegraphics[width = \textwidth]{./Evaluationimages/new-evaluation-1.pdf}
\end{figure}

\begin{figure}[H]
\caption{Order of products in the search window by descending ProductID.} \label{new-evaluation-2}
\hfill\includegraphics[width = \textwidth]{./Evaluationimages/new-evaluation-2.pdf}
\end{figure}

\begin{figure}[H]
\caption{Order of products in the search window by descending Ascending Price.} \label{new-evaluation-3}
\hfill\includegraphics[width = \textwidth]{./Evaluationimages/new-evaluation-3.pdf}
\end{figure}
...
\hfill\includegraphics[width = \textwidth]{./UserInterface/interface15.png}
\end{figure}
...
\hfill\includegraphics[width = \textwidth]{./admin-employee-menu.png}
\end{figure}
...
\hfill\includegraphics[width = \textwidth]{./Evaluationimages/restock-1.pdf}
\end{figure}

\begin{figure}[H]
\caption{Logging into the system}
\hfill\includegraphics[width = \textwidth]{./Evaluationimages/restock-2.pdf}
\end{figure}

\begin{figure}[H]
\caption{The Windows that were displayed upon log in}
\hfill\includegraphics[width = \textwidth]{./Evaluationimages/restock-3.pdf}
\end{figure}
