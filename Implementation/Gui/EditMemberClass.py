...
class editMemberClass(QWidget):
        ...
        def clicked_yes(self):
                print("before")
                editMember(self.name_title.currentText(),
                             ...
                             self.email.text(),
                             self.find_member_id_line_edit.text())
                print("after")
        ...
        def ValidatePostcode(self):
                ...
                if valid:
                        self.postcode.setStyleSheet(   """QLineEdit {
                                            border-style: solid;
                                            border-width: 1.5px;
        ...
        def validate_city(self):
                ...
                if len(self.City) > 1 and len(self.City) < 18:
                        if valid:
                                self.city.setStyleSheet(   """QLineEdit {
                                            border-style: solid;
                                            border-width: 1.5px;
                                            border-color : rgb(0,240,0);}"""  )
                else:
        ...
        def validate_town(self):
                ...
                if len(self.Town) > 3 and len(self.Town) < 32:
                        if valid:
                                self.town.setStyleSheet(   """QLineEdit {
                                            border-style: solid;
                                            border-width: 1.5px;
                                            border-color : rgb(0,240,0);}"""  )
                else:
        ...
        def validate_number(self):
                ...
                if len(self.Number) > 3 and len(self.Number) < 18:
                        if valid:
                                self.telephone_number.setStyleSheet(   """QLineEdit {
                                            border-style: solid;
                                            border-width: 1.5px;
                                            border-color : rgb(0,240,0);}"""  )
                else:
